...
namespace Pessoa.Shared.Core.FileManipulation.Contracts
{
    public interface IFileService
    {
        ...
        /// <returns></returns>
        string GetTempFileNameByUserInformation(int? customerCode, string userName, string fileExtension = "");
        ...
        /// <param name="fileExtension"></param>
        /// <returns></returns>
        string GetTempFilePathByUserInformation(int? customerCode, string userName, string fileExtension = "");
